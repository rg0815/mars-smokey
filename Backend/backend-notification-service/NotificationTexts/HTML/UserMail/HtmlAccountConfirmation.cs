...
public static class HtmlAccountConfirmation
{
                                     ...
                                     <tr>
                                       <td class='content-cell'>
                                         <div class='f-fallback'>
                                           <h1>Hallo {{name}}!</h1>
                                           <p>Danke, dass Sie mars smokey benutzen. Wir freuen uns sehr, Sie an Bord zu haben. Bitte bestätigen Sie über folgenden Link Ihre E-Mail-Adresse.</p>
                                           <!-- Action -->
